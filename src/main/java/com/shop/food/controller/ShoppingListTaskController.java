...
public class ShoppingListTaskController {
    ...
    public ResponseEntity<ResponseBody> createShoppingList(@RequestBody ShoppingListDto shoppingListDto) throws UserNotFoundException, UnauthorizedException {
        ...
        return new ResponseEntity<>(new ResponseBody("Shopping list created successfully", ResponseBody.SUCCESS, createdList), HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseBody> updateShoppingList(@PathVariable Integer listId, @RequestBody ShoppingListDto updateRequest) throws ResourceNotFoundException {
        ...
        return new ResponseEntity<>(new ResponseBody("Shopping list updated successfully", ResponseBody.SUCCESS, updatedList), HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseBody> deleteShoppingList(@PathVariable Integer listId) {
        ...
        return new ResponseEntity<>(new ResponseBody("Shopping list deleted successfully", ResponseBody.SUCCESS, null), HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseBody> getShoppingListByGroupId(@PathVariable Integer groupId) {
        ...
        return new ResponseEntity<>(new ResponseBody("Shopping lists retrieved successfully", ResponseBody.SUCCESS, shoppingLists), HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseBody> getShoppingListById(@PathVariable Integer listId) throws ResourceNotFoundException {
        ...
        return new ResponseEntity<>(new ResponseBody("Shopping list retrieved successfully", ResponseBody.SUCCESS, shoppingList), HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseBody> createTask(@RequestParam Integer listId,@RequestBody TaskDto taskDto) throws ResourceNotFoundException {
        ...
        return new ResponseEntity<>(new ResponseBody("Task created successfully", ResponseBody.SUCCESS, createdTask), HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseBody> createTasks(@RequestParam Integer listId, @RequestBody List<TaskDto> taskDtos) throws ResourceNotFoundException {
        ...
        return new ResponseEntity<>(new ResponseBody("Tasks created successfully", ResponseBody.SUCCESS, createdTasks), HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseBody> updateTask(@PathVariable Integer taskId, @RequestBody TaskDto taskDto) throws ResourceNotFoundException {
        ...
        return new ResponseEntity<>(new ResponseBody("Task updated successfully", ResponseBody.SUCCESS, updatedTask), HttpStatus.OK);
    }

    @DeleteMapping("/task/{taskId}")
    public ResponseEntity<ResponseBody> deleteTask(@PathVariable Integer taskId) {
        shoppingListTaskService.deleteTask(taskId);
        return new ResponseEntity<>(new ResponseBody("Task deleted successfully", ResponseBody.SUCCESS, null), HttpStatus.OK);
    }
}
